                ...
                <div className="md:w-3/5 w-full flex flex-col justify-center md:px-36 px-5 md:gap-10 mt-5 gap-14 md:justify-center">
                    ...
                    <div className="flex flex-col md:gap-5 gap-5">
                        ...
                        <div className="md:w-3/5 flex flex-col">
                            ...
                            <input className="md:h-12 h-12 outline-none px-3 border border-gray-500" />
                        </div>
                        <div className="md:w-3/5 flex flex-col">
                            <span>Password</span>
                            <input type={'password'} className="md:h-12 h-12 outline-none px-3 border border-gray-500" />
                        </div>
                    </div>
